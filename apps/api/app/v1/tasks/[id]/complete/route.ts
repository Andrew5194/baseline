...
// POST /v1/tasks/[id]/complete — mark a task complete regardless of type: a one-off todo
// is set done, a recurring task is checked off for today. Powers the post-timer toast action.
