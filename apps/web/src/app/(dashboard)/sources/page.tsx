...
const CONNECTABLE: Array<{ provider: string; authorize: string; name: string; blurb: string; icon: ReactNode }> = [
  {
    provider: 'github',
    authorize: 'github',
    name: 'GitHub',
    ...
    return (
      <div className="p-4 sm:p-6 lg:p-8 max-w-3xl">
        ...
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-[76px] rounded-2xl bg-neutral-200 dark:bg-neutral-800 shimmer" />
          ))}
        </div>
      </div>
    );
