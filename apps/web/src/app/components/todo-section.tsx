...
export function TodoSection({
  ...
  // Until the parent coordinates the reveal, show simple blocks sized to the real
  // layout — the Tasks label, then the heatmap, task, and Notes cards — so the page
  // reads as its own structure filling in, without shimmering every detail.
  if (!reveal) {
    return (
      <div className="mt-10 space-y-6">
        ...
        <div className="h-52 rounded-2xl bg-neutral-200 dark:bg-neutral-800 shimmer" />
        <div className="h-40 rounded-2xl bg-neutral-200 dark:bg-neutral-800 shimmer" />
      </div>
    );
  }
